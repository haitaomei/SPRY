...
public class DServerCapacityFinder {
    ...
    public DServer findMaxCapacity(ArrayList<PeriodicTask> hardPeriodics, int serverPriority, double serverPeriod,
        ...
        ArrayList<PeriodicTask> tasks = new ArrayList<>(hardPeriodics);

        double capacity = 0;
        PeriodicTask t = null;

        for (PeriodicTask hardPeriodic : hardPeriodics) {
            t = hardPeriodic;
        ...
        capacity = MIN;
        DServer server = new DServer(serverPriority, serverPeriod, capacity, serverPeriod);
        ...
        if (found) {
			...
			*/
            DServer serverFound = new DServer(serverPriority, serverPeriod, capacity, serverPeriod);
