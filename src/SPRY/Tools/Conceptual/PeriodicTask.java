...
public class PeriodicTask {
    ...
    public PeriodicTask(int priority, double period, double WCET, double deadline, double jitter, double releaseTime,
                        String name) {
    ...
    public String toString() {
        return "T = " + String.format("%1.0f", this.period) + ", C = " + String.format("%1.3f", this.WCET)
                + ", D = " + String.format("%1.0f", this.deadline) + ", Priority = " + this.priority
                + "  " + this.name;
    }
